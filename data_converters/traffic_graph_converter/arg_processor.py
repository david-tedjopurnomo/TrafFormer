...
class ArgProcessor():
    ...
    def __init__(self, ini_path):
        ...
        self.input_h5_path      = Path(config['INPUT']['InputH5Path'])
        self.input_weight_path  = Path(config['INPUT']['InputWeightPath'])
    
        self.output_weight_path    = Path(config['OUTPUT']['OutputWeightPath'])